...
using System.Text;
//using System.Web.Script.Serialization;  // netfx 4.5
...
static class Program
{
	static void Main()
	{
		...
		GC.WaitForPendingFinalizers();
		{
            ...
            var ser = new HolisticWare.Core.Serialization.SharpSerializer.SharpSerializer(true); // SharpSerializer Binary
			Console.WriteLine();
			Console.WriteLine(ser.GetType().Name);
