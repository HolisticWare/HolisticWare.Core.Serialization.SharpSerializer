...
using HolisticWare.Core.Serialization.SharpSerializer;
...
namespace HelloWorldApp
{
	public partial class Form1
	{
		private SharpSerializerXmlSettings createXmlSettings()
		{
			...
			// ADVANCED SETTINGS
			// Most of the classes needed to alter these settings are in the namespace HolisticWare.Core.Serialization.SharpSerializer.Advanced
		...
		private SharpSerializer createSerializerWithCustomReaderAndWriter()
		{
			// *************************************************************************************
			// SERIALIZATION
			// The namespace HolisticWare.Core.Serialization.SharpSerializer.Advanced contains some classes which are indispensable during the serialization.
			...
			HolisticWare.Core.Serialization.SharpSerializer.Advanced.Xml.IXmlWriter jsonWriter = new MyJsonWriter();

			// this writer is passed to the constructor of the XmlPropertySerializer
			HolisticWare.Core.Serialization.SharpSerializer.Advanced.Serializing.IPropertySerializer serializer =
				new HolisticWare.Core.Serialization.SharpSerializer.Advanced.XmlPropertySerializer(jsonWriter);
			...
			HolisticWare.Core.Serialization.SharpSerializer.Advanced.Binary.IBinaryWriter compressedWriter = new MyVeryStrongCompressedAndEncryptedBinaryWriter();

			// this writer is passed to the constructor of the BinaryPropertySerializer
			serializer = new HolisticWare.Core.Serialization.SharpSerializer.Advanced.BinaryPropertySerializer(compressedWriter);
			...
			// *************************************************************************************
			// DESERIALIZATION
			// The namespace HolisticWare.Core.Serialization.SharpSerializer.Advanced contains classes which are counterparts of the above serializers/writers
			...
			HolisticWare.Core.Serialization.SharpSerializer.Advanced.Binary.IBinaryReader compressedReader =
				new MyVeryStrongCompressedAndEncryptedBinaryReader();

			HolisticWare.Core.Serialization.SharpSerializer.Advanced.Deserializing.IPropertyDeserializer deserializer =
				new HolisticWare.Core.Serialization.SharpSerializer.Advanced.BinaryPropertyDeserializer(compressedReader);
		...
		/// </summary>
		private class MyCustomSimpleValueConverter : HolisticWare.Core.Serialization.SharpSerializer.Advanced.Xml.ISimpleValueConverter
		{
			/// <summary>
			/// </summary>
		...
		/// It's only a fake class!
		/// </summary>
		private class MyTypeNameConverterWithCompressedTypeNames : HolisticWare.Core.Serialization.SharpSerializer.Advanced.Serializing.ITypeNameConverter
		{
			/// <summary>
		...
		/// It's only a fake class!
		/// </summary>
		private class MyJsonWriter : HolisticWare.Core.Serialization.SharpSerializer.Advanced.Xml.IXmlWriter
		{
			///<summary>
		...
		/// It's only a fake class!
		/// </summary>
		private class MyVeryStrongCompressedAndEncryptedBinaryWriter : HolisticWare.Core.Serialization.SharpSerializer.Advanced.Binary.IBinaryWriter
		{
			/// <summary>
			///   Writes Element Id
			/// </summary>
		...
		/// It's only a fake class!
		/// </summary>
		private class MyVeryStrongCompressedAndEncryptedBinaryReader : HolisticWare.Core.Serialization.SharpSerializer.Advanced.Binary.IBinaryReader
		{
			/// <summary>
			///   Reads single byte
			/// </summary>
		...
		/// It's only a fake class!
		/// </summary>
		private class MyVerySophisticatedPropertyProvider : HolisticWare.Core.Serialization.SharpSerializer.Advanced.PropertyProvider
		{
		}
		//-------------------------------------------------------------------------
