...
namespace Polenter.Serialization.Core
{
    ...
    public class ArrayAnalyzer
    {
        ...
        {
            MethodInfo methodInfo = arrayType.GetTypeInfo().GetMethod("GetLength", BindingFlags.Public);
...
//        }
        ...
        {
            MethodInfo methodInfo = arrayType.GetTypeInfo().GetMethod(methodName, BindingFlags.Public);
