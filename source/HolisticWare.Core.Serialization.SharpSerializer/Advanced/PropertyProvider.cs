...
namespace HolisticWare.Core.Serialization.SharpSerializer.Advanced
{
    ...
    public class PropertyProvider
    {
        ...
        /// <returns></returns>
        public IList<PropertyInfo> GetProperties(HolisticWare.Core.Serialization.SharpSerializer.Serializing.TypeInfo typeInfo)
        {
            // Search in cache
        ...
        ///   - is indexer
        /// </returns>
        protected virtual bool IgnoreProperty(HolisticWare.Core.Serialization.SharpSerializer.Serializing.TypeInfo info, PropertyInfo property)
        {
