...
using HolisticWare.Core.Serialization.SharpSerializer.Core.Xml;

namespace HolisticWare.Core.Serialization.SharpSerializer.Advanced
{
    /// <summary>
    ...
    public sealed class XmlPropertyDeserializer : IPropertyDeserializer
    {
        ...
        {
            // ElementType
            property.ElementType = property.Type != null ? HolisticWare.Core.Serialization.SharpSerializer.Serializing.TypeInfo.GetTypeInfo(property.Type).ElementType : null;
        ...
        private void parseDictionaryProperty(DictionaryProperty property)
        {
            ...
            {
                var typeInfo = HolisticWare.Core.Serialization.SharpSerializer.Serializing.TypeInfo.GetTypeInfo(property.Type);
