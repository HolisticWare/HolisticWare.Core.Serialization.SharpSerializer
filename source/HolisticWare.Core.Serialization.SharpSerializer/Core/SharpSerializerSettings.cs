...
namespace HolisticWare.Core.Serialization.SharpSerializer.Core
{
    /// <summary>
    ...
    public abstract class SharpSerializerSettings<T> where T : AdvancedSharpSerializerSettings, new()
    {
        ...
        /// <summary>
        ///   Contains mostly classes from the namespace HolisticWare.Core.Serialization.SharpSerializer.Advanced
        /// </summary>
