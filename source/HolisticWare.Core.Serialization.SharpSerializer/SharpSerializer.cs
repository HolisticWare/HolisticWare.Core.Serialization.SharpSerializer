...
using System.IO;
using System.Xml;
using HolisticWare.Core.Serialization.SharpSerializer.Advanced;
using HolisticWare.Core.Serialization.SharpSerializer.Advanced.Binary;
using HolisticWare.Core.Serialization.SharpSerializer.Advanced.Deserializing;
using HolisticWare.Core.Serialization.SharpSerializer.Advanced.Serializing;
using HolisticWare.Core.Serialization.SharpSerializer.Advanced.Xml;
using HolisticWare.Core.Serialization.SharpSerializer.Core;
using HolisticWare.Core.Serialization.SharpSerializer.Deserializing;
using HolisticWare.Core.Serialization.SharpSerializer.Serializing;
using System.Runtime.CompilerServices;

namespace HolisticWare.Core.Serialization.SharpSerializer
{
    /// <summary>
    ...
    public sealed class SharpSerializer
    {
        ...
        private void initialize(SharpSerializerBinarySettings settings)
        {
            ...
            // Create Serializer and Deserializer
            HolisticWare.Core.Serialization.SharpSerializer.Advanced.Binary.IBinaryReader reader = null;
            HolisticWare.Core.Serialization.SharpSerializer.Advanced.Binary.IBinaryWriter writer = null;
